...
def shift_grid(array_to_shift,shift_amount_x,shift_amount_y):
    '''Shifts a given 2D array by a given amount. 
    Args:
        array_to_shift: the 2D array to be shifted
        shift_amount_x: amount to shift the array in x direction (in meters)
        shift_amount_y: amount to shift the array in y direction (in meters)
    Returns:
        the shifted 2D array'''
    pass
...
if __name__ == "__main__":
    ...
    solver.set_param("inner_maxeval", 10)
